...
class PyZbarValidationError(PyZbarError):
    ...
    can tell "we rejected obviously hostile/malformed input in pure
    Python" apart from "zbar itself raised a decode error", without
    needing to string-match exception messages.
    """
    pass
